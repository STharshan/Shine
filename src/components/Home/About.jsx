...
const AboutSection = () => {
  ...
  const testimonials = [
  {
    text: "Darren did a great job cleaning our caravan, removed all the pesky marks and streaks, all the windows and perfect and cleaned the roof. Was working for over 5 hours and did an amazing job Will recommend to everyone and anyone",
    name: "John Blackwell",
  },
